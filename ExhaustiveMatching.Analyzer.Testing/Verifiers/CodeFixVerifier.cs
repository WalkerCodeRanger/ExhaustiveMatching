...
namespace ExhaustiveMatching.Analyzer.Testing.Verifiers
{
    ...
    public abstract partial class CodeFixVerifier : DiagnosticVerifier
    {
        ...
        {
            return VerifyCSharpFixAsync(GetCSharpDiagnosticAnalyzer(), GetCSharpCodeFixProvider(), oldSource, newSource, codeFixIndex, allowNewCompilerDiagnostics);
        }
        ...
        /// <param name="codeFixIndex">Index determining which codefix to apply if there are multiple</param>
        /// <param name="allowNewCompilerDiagnostics">A bool controlling whether or not the test will fail if the CodeFix introduces other warnings after being applied</param>
        private async Task VerifyCSharpFixAsync(
